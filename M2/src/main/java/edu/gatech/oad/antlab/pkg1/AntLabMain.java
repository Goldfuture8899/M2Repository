 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("klee702");
		  toPrint += p1.toString("Kyung Jun Lee");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("hkim771");
		  toPrint += p2.toString("Haerim KIm");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("echung34");
		  toPrint += p3.toString("Eun Ji Chung");
